        ...
        <div className="col-12 col-md-6 col-lg-4 my-2">
            <div className="card border border-success">
                ...
                <div className="card-body">
                    <h5 className="card-title">{title} {authorize ? <span class="badge text-bg-success">Pubblicato</span> : <span class="badge text-bg-warning">Bozza</span>}</h5>
                    {/* CONTENUTO POST */}
                    ...
                    <div className="row justify-content-between align-items-center ms-0">
                        ...
                        <div className="col-6 position-relative border border-3 border-primary rounded-3 mt-3 pb-5">
                            <h2 className="text-white border rounded bg-primary rounded-pill shadow p-2 mb-1 bg-body-primary rounded position-relative top-4 start-50 translate-middle p-0">Tags</h2>
                            {tags.map((tag, index) => (
